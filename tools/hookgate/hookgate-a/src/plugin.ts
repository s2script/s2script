...
// The one that matters most is the BYPASS: `gameRules.onTerminateRound` must NOT fire when a
...
export function OnPluginEnd(): void {
  console.log("[HOOKGATE] unloading");
}
