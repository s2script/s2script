...
static void PushR6Pending() {
    PushPending("fire_event_handled_recipient_mask", "native_handled_original_once", "native",
                "{\"orig\":1,\"automatic_skipped\":true}",
                "R6: Handled recipient-mask original/listener not implemented");
    PushPending("fire_event_handled_recipient_mask", "native_outgoing_recipient_decisions", "native",
                "{\"subset\":true}", "R6: outgoing recipient decisions need real clients");
    PushPending("voice_recall", "native_voice_listen_bits", "native", "{\"allowed\":true,\"denied\":false}",
                "R6: voice listen bits need three clients");
    PushPending("voice_recall", "native_voice_original_once", "native", "{\"orig\":1}",
                "R6: voice original observation not implemented");
    PushPending("sdkhooks_one_of_two_entities", "native_spawn_a_ok", "native", "{\"spawned\":true}",
                "R6: entity spawn state machine not implemented");
    ...
    PushPending("sdkhooks_phase_removal", "native_phase_subscribe_pre_post", "native",
                "{\"pre\":1,\"post\":1,\"original\":1}", "R6: SDKHooks phase removal not implemented");
    PushPending("sdkhooks_phase_removal", "native_phase_remove_pre", "native",
                "{\"pre\":0,\"post\":1,\"original\":1}", "R6: SDKHooks phase removal not implemented");
    PushPending("sdkhooks_phase_removal", "native_phase_remove_post", "native",
                "{\"pre\":1,\"post\":0,\"original\":1}", "R6: SDKHooks phase removal not implemented");
    PushPending("sdkhooks_phase_removal", "native_phase_self_unsubscribe", "native",
                "{\"first_pre\":1,\"second_pre\":0}", "R6: SDKHooks phase removal not implemented");
    PushPending("sdkhooks_phase_removal", "native_phase_final_unsubscribe", "native",
                "{\"pre\":0,\"post\":0,\"original\":1}", "R6: SDKHooks phase removal not implemented");
    PushPending("entity_slot_reuse_map_teardown", "native_identity_persisted", "native",
                "{\"persisted\":true}", "R6: slot reuse/map/teardown not implemented");
    PushPending("entity_slot_reuse_map_teardown", "native_slot_reuse_no_stale", "native",
                "{\"stale\":false}", "R6: slot reuse/map/teardown not implemented");
    PushPending("entity_slot_reuse_map_teardown", "native_map_teardown_clears", "native",
                "{\"cleared\":true}", "R6: slot reuse/map/teardown not implemented");
    PushPending("entity_slot_reuse_map_teardown", "native_unload_reload", "native", "{\"reloaded\":true}",
                "R6: unload/reload not implemented");
    PushPending("check_transmit", "native_first_fire_layout", "native", "{\"layout_ok\":true}",
                "R6: check_transmit not implemented");
