...
export default plugin((ctx) => {
  console.log("[gate] load — armed (watch player_spawn + per-frame poll for a live pawn to hold)");
  ...
  ctx.server.onMapStart((map) => console.log(`[gate] map start: ${map} — held ref should now be dead`));
