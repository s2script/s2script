...
/**
 * Cancellable callback timers (SourceMod `CreateTimer` / `KillTimer`).
 *
...
export const describe = "cancellable timers: sm_timer_once, sm_timer_repeat <ms>, sm_timer_stop, sm_timer_status";
