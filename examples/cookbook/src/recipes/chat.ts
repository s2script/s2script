 ...
 * that sits at the very front of the message, so Chat auto-prepends an invisible
...
export const describe = "print to chat, plain and multi-color inline (sm_saycolor)";
