...
/**
 * The same Database API drives SQLite, MySQL, and Postgres alike — only
...
export const describe = "round-trip SQLite (sm_db) or operator-configured mysql/postgres (sm_db_remote)";
