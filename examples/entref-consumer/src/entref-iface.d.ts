...
// published shape by hand so `import ent = require("@demo/ent")` type-checks. `pawnRef` hands back an
// EntityRef — the same @s2script/std type the entity system uses — that the wire rehydrates into a
