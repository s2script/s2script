...
| [`interop-observer`](examples/interop-observer) | An optional protocol 2 consumer that watches BaseComm mute/gag policy, owns per-provider subscriptions, and builds from a verified types-only contract copy. |
