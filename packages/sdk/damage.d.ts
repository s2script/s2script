 ...
 *
 * Subscribe with `SDKHook` (`SDKHookType.OnTakeDamage`), not a global mux.
 */
import type { EntityRef } from "./entity";

/**
 * A block-scoped view of the current damage event (valid only inside an `OnTakeDamage` SDKHook).
 * @example
