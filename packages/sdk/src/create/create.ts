    ...
    JSON.stringify(
      {
        ...
        // All generated declarations are typecheck roots internally. Include them as a group so
        // editors also see v1 gamedata, interfaces, and auto-discovered engine functions.
        include: ["src", ".s2script/*.d.ts", "node_modules/@s2script/sdk/globals.d.ts"],
      },
      null,
      2,
    ) + "\n"
