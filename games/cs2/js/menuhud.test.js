...
test("clearing an untracked slot does not release an unrelated manual cursor lease", () => {
  // Host disconnect cleanup owns slot-wide reset; a presenter can release only its claim.
  const mounted = mount();
