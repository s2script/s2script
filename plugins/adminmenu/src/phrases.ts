...
export const phrases = {
  ...
  // none may gain one later: every Menu in this plugin is MenuStyle.Center (plugin.ts:32,62), whose
  // HTML renderer never expands {tag} syntax (it HTML-escapes title/item text and paints its own
  // fixed <font color=...> styling — see basebans' ban-duration menu, Task 7). A {tag} added to any
  // key below would render as literal, escaped text in the menu, not a colour.
