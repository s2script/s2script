...
pub type EngineCallInvokeFn = extern "C" fn(call_id: c_int, ent_index: c_int, ent_serial: c_int, subobj_off: c_int, arg_class: *const u8, arg_count: c_int, gp: *const u64, gp_kind: *const u8, gp_count: c_int, fp: *const f64, fp_count: c_int, strs: *const *const c_char, vecs: *const f32, ret_kind: c_int, ret_out: *mut u64) -> c_int;
