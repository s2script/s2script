#!/usr/bin/env bash
# Build the actual corrected host and both consumers against GLIBC <= 2.31.
...
echo '== corrected Metamod AMBuild (sniper) =='
...
PY
echo 'KHook sniper build: corrected host, shim/core, and probe verified'
