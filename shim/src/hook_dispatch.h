...
enum S2HookShape {
    ...
    // 3 and 4 (the pickup-gate and HUD-click shapes) are retired and never reused: those engine
    // functions are trusted package functions with their semantics in package adapters now.
};
